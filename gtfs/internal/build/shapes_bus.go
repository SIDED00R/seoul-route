...
// 버스 경로선(shape) 상수. 2026-09-19 서울 버스 API 의 노선 경로(getRoutePath)로 잰 값이고, 근거는
// docs/gtfs-generator.md 에 있다. 노선 경로나 정류장 좌표 출처가 바뀌면 다시 잰다.
//   - BusSnapM 100: 정류장이 경로에서 이보다 멀면 경로에서 어긋난 정류장으로 센다.
